...
export function Home() {
  ...
  }, [allCountries, allActivitiesTypes, dispatch]);
  ...
  const configuredCountries = useMemo(() => {
    console.log("render " + renderCountries[0]?.name);
    console.log("filters " + filterConfig.activity);
      ...
      (c) =>
        ...
        (filterConfig.activity.length
          ? c.Activities.reduce((bool, act) => {
              ...
              console.log("filter " + filterConfig.activity);
